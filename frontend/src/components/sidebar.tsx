...
function useSidebarItems(): SidebarItem[] {
  ...
  return useMemo(
    (): SidebarItem[] => [
      ...
      {
        title: t("sidebar.agent-hub"),
        icon: Radio,
        name: SETTINGS_ROUTE_HUB,
        type: "route",
        hide: !canSettingsGet,
      },
      {
        ...
        children: [
          ...
          {
            title: t("sidebar.settings-memberships"),
          ...
          },
          {
            ...
            name: SETTINGS_ROUTE_APPROVALS,
            type: "route",
            hide: !canSettingsGet,
          },
          {
            title: t("usage-summary.title"),
            name: SETTINGS_ROUTE_USAGE,
            type: "route",
            hide: !canSettingsGet,
          },
          {
            title: t("connector-status.title"),
            name: SETTINGS_ROUTE_CONNECTORS,
            type: "route",
            hide: !canSettingsGet,
          },
          {
            title: t("a2a-graph.title"),
            name: SETTINGS_ROUTE_A2A_GRAPH,
            type: "route",
            hide: !canSettingsGet,
          },
        ],
