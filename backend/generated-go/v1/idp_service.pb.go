...
type CreateIdentityProviderRequest struct {
	...
	// The ID to use for the identity provider, which will become the final
	// component of the identity provider's resource name.
	...
	// If set to true, the request will be validated without actually creating
...
type UpdateIdentityProviderRequest struct {
	...
	// The identity provider's `name` field is used to identify the identity
	// provider to update. Format: idps/{identity_provider}
	IdentityProvider *IdentityProvider `protobuf:"bytes,1,opt,name=identity_provider,json=identityProvider,proto3" json:"identity_provider,omitempty"`
	// The list of fields to update.
	UpdateMask *fieldmaskpb.FieldMask `protobuf:"bytes,2,opt,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"`
	// If set to true, and the identity provider is not found, a new identity
	// provider will be created. In this situation, `update_mask` is ignored.
...
type IdentityProvider struct {
	...
	Type IdentityProviderType `protobuf:"varint,4,opt,name=type,proto3,enum=laelia.v1.IdentityProviderType" json:"type,omitempty"`
...
type OAuth2IdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle `protobuf:"varint,9,opt,name=auth_style,json=authStyle,proto3,enum=laelia.v1.OAuth2AuthStyle" json:"auth_style,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type OIDCIdentityProviderConfig struct {
	...
	// The authentication style for client credentials.
	AuthStyle     OAuth2AuthStyle `protobuf:"varint,7,opt,name=auth_style,json=authStyle,proto3,enum=laelia.v1.OAuth2AuthStyle" json:"auth_style,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LDAPIdentityProviderConfig struct {
	...
	SecurityProtocol LDAPIdentityProviderConfig_SecurityProtocol `protobuf:"varint,8,opt,name=security_protocol,json=securityProtocol,proto3,enum=laelia.v1.LDAPIdentityProviderConfig_SecurityProtocol" json:"security_protocol,omitempty"`
...
const file_v1_idp_service_proto_rawDesc = "" +
	"\n" +
	"\x14v1/idp_service.proto\x12\tlaelia.v1\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x13v1/annotation.proto\"D\n" +
	"\x1aGetIdentityProviderRequest\x12&\n" +
	"\x04name\x18\x01 \x01(\tB\x12\xe0A\x02\xfaA\f\n" +
	"\n" +
	"laelia/IdPR\x04name\"\x1e\n" +
	"\x1cListIdentityProvidersRequest\"k\n" +
	"\x1dListIdentityProvidersResponse\x12J\n" +
	"\x12identity_providers\x18\x01 \x03(\v2\x1b.laelia.v1.IdentityProviderR\x11identityProviders\"\xc5\x01\n" +
	"\x1dCreateIdentityProviderRequest\x12M\n" +
	"\x11identity_provider\x18\x01 \x01(\v2\x1b.laelia.v1.IdentityProviderB\x03\xe0A\x02R\x10identityProvider\x120\n" +
	"\x14identity_provider_id\x18\x02 \x01(\tR\x12identityProviderId\x12#\n" +
	"\rvalidate_only\x18\x03 \x01(\bR\fvalidateOnly\"\xd0\x01\n" +
	"\x1dUpdateIdentityProviderRequest\x12M\n" +
	"\x11identity_provider\x18\x01 \x01(\v2\x1b.laelia.v1.IdentityProviderB\x03\xe0A\x02R\x10identityProvider\x12;\n" +
	...
	"\x04name\x18\x01 \x01(\tB\x12\xe0A\x02\xfaA\f\n" +
	"\n" +
	"laelia/IdPR\x04name\"\x80\x03\n" +
	"\x1bTestIdentityProviderRequest\x12H\n" +
	"\x11identity_provider\x18\x01 \x01(\v2\x1b.laelia.v1.IdentityProviderR\x10identityProvider\x12\\\n" +
	"\x0eoauth2_context\x18\x02 \x01(\v23.laelia.v1.OAuth2IdentityProviderTestRequestContextH\x00R\roauth2Context\x12V\n" +
	"\foidc_context\x18\x03 \x01(\v21.laelia.v1.OIDCIdentityProviderTestRequestContextH\x00R\voidcContext\x12V\n" +
	"\fldap_context\x18\x04 \x01(\v21.laelia.v1.LDAPIdentityProviderTestRequestContextH\x00R\vldapContextB\t\n" +
	"\acontext\">\n" +
	...
	"\x1cTestIdentityProviderResponse\x12K\n" +
	"\x06claims\x18\x01 \x03(\v23.laelia.v1.TestIdentityProviderResponse.ClaimsEntryR\x06claims\x12R\n" +
	"\tuser_info\x18\x02 \x03(\v25.laelia.v1.TestIdentityProviderResponse.UserInfoEntryR\buserInfo\x1a9\n" +
	...
	"\x04type\x18\x04 \x01(\x0e2\x1f.laelia.v1.IdentityProviderTypeR\x04type\x129\n" +
	"\x06config\x18\x05 \x01(\v2!.laelia.v1.IdentityProviderConfigR\x06config:\x1b\xeaA\x18\n" +
	"\n" +
	"laelia/IdP\x12\n" +
	"idps/{idp}\"\x86\x02\n" +
	"\x16IdentityProviderConfig\x12N\n" +
	"\roauth2_config\x18\x01 \x01(\v2'.laelia.v1.OAuth2IdentityProviderConfigH\x00R\foauth2Config\x12H\n" +
	"\voidc_config\x18\x02 \x01(\v2%.laelia.v1.OIDCIdentityProviderConfigH\x00R\n" +
	"oidcConfig\x12H\n" +
	"\vldap_config\x18\x03 \x01(\v2%.laelia.v1.LDAPIdentityProviderConfigH\x00R\n" +
	"ldapConfigB\b\n" +
	"\x06config\"\xf5\x02\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x17.laelia.v1.FieldMappingR\ffieldMapping\x12&\n" +
	"\x0fskip_tls_verify\x18\b \x01(\bR\rskipTlsVerify\x129\n" +
	"\n" +
	"auth_style\x18\t \x01(\x0e2\x1a.laelia.v1.OAuth2AuthStyleR\tauthStyle\"\xaf\x02\n" +
	...
	"\rfield_mapping\x18\x05 \x01(\v2\x17.laelia.v1.FieldMappingR\ffieldMapping\x12&\n" +
	"\x0fskip_tls_verify\x18\x06 \x01(\bR\rskipTlsVerify\x129\n" +
	"\n" +
	"auth_style\x18\a \x01(\x0e2\x1a.laelia.v1.OAuth2AuthStyleR\tauthStyle\"\xd8\x03\n" +
	...
	"userFilter\x12c\n" +
	"\x11security_protocol\x18\b \x01(\x0e26.laelia.v1.LDAPIdentityProviderConfig.SecurityProtocolR\x10securityProtocol\x12<\n" +
	"\rfield_mapping\x18\t \x01(\v2\x17.laelia.v1.FieldMappingR\ffieldMapping\"O\n" +
	...
	"\tIN_HEADER\x10\x022\x9f\a\n" +
	"\x17IdentityProviderService\x12\x86\x01\n" +
	"\x13GetIdentityProvider\x12%.laelia.v1.GetIdentityProviderRequest\x1a\x1b.laelia.v1.IdentityProvider\"+\xdaA\x04name\x8a\xea0\x1claelia.identityProviders.get\x90\xea0\x01\x12p\n" +
	"\x15ListIdentityProviders\x12'.laelia.v1.ListIdentityProvidersRequest\x1a(.laelia.v1.ListIdentityProvidersResponse\"\x04\x80\xea0\x01\x12\xb5\x01\n" +
...
var file_v1_idp_service_proto_goTypes = []any{
	(IdentityProviderType)(0),                        // 0: laelia.v1.IdentityProviderType
	(OAuth2AuthStyle)(0),                             // 1: laelia.v1.OAuth2AuthStyle
	(LDAPIdentityProviderConfig_SecurityProtocol)(0), // 2: laelia.v1.LDAPIdentityProviderConfig.SecurityProtocol
	(*GetIdentityProviderRequest)(nil),               // 3: laelia.v1.GetIdentityProviderRequest
	(*ListIdentityProvidersRequest)(nil),             // 4: laelia.v1.ListIdentityProvidersRequest
	(*ListIdentityProvidersResponse)(nil),            // 5: laelia.v1.ListIdentityProvidersResponse
	(*CreateIdentityProviderRequest)(nil),            // 6: laelia.v1.CreateIdentityProviderRequest
	(*UpdateIdentityProviderRequest)(nil),            // 7: laelia.v1.UpdateIdentityProviderRequest
	(*DeleteIdentityProviderRequest)(nil),            // 8: laelia.v1.DeleteIdentityProviderRequest
	(*TestIdentityProviderRequest)(nil),              // 9: laelia.v1.TestIdentityProviderRequest
	(*OAuth2IdentityProviderTestRequestContext)(nil), // 10: laelia.v1.OAuth2IdentityProviderTestRequestContext
	(*OIDCIdentityProviderTestRequestContext)(nil),   // 11: laelia.v1.OIDCIdentityProviderTestRequestContext
	(*LDAPIdentityProviderTestRequestContext)(nil),   // 12: laelia.v1.LDAPIdentityProviderTestRequestContext
	(*TestIdentityProviderResponse)(nil),             // 13: laelia.v1.TestIdentityProviderResponse
	(*IdentityProvider)(nil),                         // 14: laelia.v1.IdentityProvider
	(*IdentityProviderConfig)(nil),                   // 15: laelia.v1.IdentityProviderConfig
	(*OAuth2IdentityProviderConfig)(nil),             // 16: laelia.v1.OAuth2IdentityProviderConfig
	(*OIDCIdentityProviderConfig)(nil),               // 17: laelia.v1.OIDCIdentityProviderConfig
	(*LDAPIdentityProviderConfig)(nil),               // 18: laelia.v1.LDAPIdentityProviderConfig
	(*FieldMapping)(nil),                             // 19: laelia.v1.FieldMapping
	nil,                                              // 20: laelia.v1.TestIdentityProviderResponse.ClaimsEntry
	nil,                                              // 21: laelia.v1.TestIdentityProviderResponse.UserInfoEntry
	(*fieldmaskpb.FieldMask)(nil),                    // 22: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                            // 23: google.protobuf.Empty
}
var file_v1_idp_service_proto_depIdxs = []int32{
	14, // 0: laelia.v1.ListIdentityProvidersResponse.identity_providers:type_name -> laelia.v1.IdentityProvider
	14, // 1: laelia.v1.CreateIdentityProviderRequest.identity_provider:type_name -> laelia.v1.IdentityProvider
	14, // 2: laelia.v1.UpdateIdentityProviderRequest.identity_provider:type_name -> laelia.v1.IdentityProvider
	22, // 3: laelia.v1.UpdateIdentityProviderRequest.update_mask:type_name -> google.protobuf.FieldMask
	14, // 4: laelia.v1.TestIdentityProviderRequest.identity_provider:type_name -> laelia.v1.IdentityProvider
	10, // 5: laelia.v1.TestIdentityProviderRequest.oauth2_context:type_name -> laelia.v1.OAuth2IdentityProviderTestRequestContext
	11, // 6: laelia.v1.TestIdentityProviderRequest.oidc_context:type_name -> laelia.v1.OIDCIdentityProviderTestRequestContext
	12, // 7: laelia.v1.TestIdentityProviderRequest.ldap_context:type_name -> laelia.v1.LDAPIdentityProviderTestRequestContext
	20, // 8: laelia.v1.TestIdentityProviderResponse.claims:type_name -> laelia.v1.TestIdentityProviderResponse.ClaimsEntry
	21, // 9: laelia.v1.TestIdentityProviderResponse.user_info:type_name -> laelia.v1.TestIdentityProviderResponse.UserInfoEntry
	0,  // 10: laelia.v1.IdentityProvider.type:type_name -> laelia.v1.IdentityProviderType
	15, // 11: laelia.v1.IdentityProvider.config:type_name -> laelia.v1.IdentityProviderConfig
	16, // 12: laelia.v1.IdentityProviderConfig.oauth2_config:type_name -> laelia.v1.OAuth2IdentityProviderConfig
	17, // 13: laelia.v1.IdentityProviderConfig.oidc_config:type_name -> laelia.v1.OIDCIdentityProviderConfig
	18, // 14: laelia.v1.IdentityProviderConfig.ldap_config:type_name -> laelia.v1.LDAPIdentityProviderConfig
	19, // 15: laelia.v1.OAuth2IdentityProviderConfig.field_mapping:type_name -> laelia.v1.FieldMapping
	1,  // 16: laelia.v1.OAuth2IdentityProviderConfig.auth_style:type_name -> laelia.v1.OAuth2AuthStyle
	19, // 17: laelia.v1.OIDCIdentityProviderConfig.field_mapping:type_name -> laelia.v1.FieldMapping
	1,  // 18: laelia.v1.OIDCIdentityProviderConfig.auth_style:type_name -> laelia.v1.OAuth2AuthStyle
	2,  // 19: laelia.v1.LDAPIdentityProviderConfig.security_protocol:type_name -> laelia.v1.LDAPIdentityProviderConfig.SecurityProtocol
	19, // 20: laelia.v1.LDAPIdentityProviderConfig.field_mapping:type_name -> laelia.v1.FieldMapping
	3,  // 21: laelia.v1.IdentityProviderService.GetIdentityProvider:input_type -> laelia.v1.GetIdentityProviderRequest
	4,  // 22: laelia.v1.IdentityProviderService.ListIdentityProviders:input_type -> laelia.v1.ListIdentityProvidersRequest
	6,  // 23: laelia.v1.IdentityProviderService.CreateIdentityProvider:input_type -> laelia.v1.CreateIdentityProviderRequest
	7,  // 24: laelia.v1.IdentityProviderService.UpdateIdentityProvider:input_type -> laelia.v1.UpdateIdentityProviderRequest
	8,  // 25: laelia.v1.IdentityProviderService.DeleteIdentityProvider:input_type -> laelia.v1.DeleteIdentityProviderRequest
	9,  // 26: laelia.v1.IdentityProviderService.TestIdentityProvider:input_type -> laelia.v1.TestIdentityProviderRequest
	14, // 27: laelia.v1.IdentityProviderService.GetIdentityProvider:output_type -> laelia.v1.IdentityProvider
	5,  // 28: laelia.v1.IdentityProviderService.ListIdentityProviders:output_type -> laelia.v1.ListIdentityProvidersResponse
	14, // 29: laelia.v1.IdentityProviderService.CreateIdentityProvider:output_type -> laelia.v1.IdentityProvider
	14, // 30: laelia.v1.IdentityProviderService.UpdateIdentityProvider:output_type -> laelia.v1.IdentityProvider
	23, // 31: laelia.v1.IdentityProviderService.DeleteIdentityProvider:output_type -> google.protobuf.Empty
	13, // 32: laelia.v1.IdentityProviderService.TestIdentityProvider:output_type -> laelia.v1.TestIdentityProviderResponse
