...
const (
	...
	IdentityProviderServiceName = "laelia.v1.IdentityProviderService"
)
...
const (
	...
	IdentityProviderServiceGetIdentityProviderProcedure = "/laelia.v1.IdentityProviderService/GetIdentityProvider"
	...
	IdentityProviderServiceListIdentityProvidersProcedure = "/laelia.v1.IdentityProviderService/ListIdentityProviders"
	...
	IdentityProviderServiceCreateIdentityProviderProcedure = "/laelia.v1.IdentityProviderService/CreateIdentityProvider"
	...
	IdentityProviderServiceUpdateIdentityProviderProcedure = "/laelia.v1.IdentityProviderService/UpdateIdentityProvider"
	...
	IdentityProviderServiceDeleteIdentityProviderProcedure = "/laelia.v1.IdentityProviderService/DeleteIdentityProvider"
	...
	IdentityProviderServiceTestIdentityProviderProcedure = "/laelia.v1.IdentityProviderService/TestIdentityProvider"
)

// IdentityProviderServiceClient is a client for the laelia.v1.IdentityProviderService service.
type IdentityProviderServiceClient interface {
	// Gets an identity provider by name.
	// Permissions required: laelia.identityProviders.get
	...
	// Lists all configured identity providers. Public so the login page can
	// render the enabled SSO targets without credentials.
	...
	// Permissions required: laelia.identityProviders.create
	...
	// Permissions required: laelia.identityProviders.update
	...
	// Permissions required: laelia.identityProviders.delete
...
// NewIdentityProviderServiceClient constructs a client for the laelia.v1.IdentityProviderService
...
// GetIdentityProvider calls laelia.v1.IdentityProviderService.GetIdentityProvider.
...
// ListIdentityProviders calls laelia.v1.IdentityProviderService.ListIdentityProviders.
...
// CreateIdentityProvider calls laelia.v1.IdentityProviderService.CreateIdentityProvider.
...
// UpdateIdentityProvider calls laelia.v1.IdentityProviderService.UpdateIdentityProvider.
...
// DeleteIdentityProvider calls laelia.v1.IdentityProviderService.DeleteIdentityProvider.
...
// TestIdentityProvider calls laelia.v1.IdentityProviderService.TestIdentityProvider.
...
// IdentityProviderServiceHandler is an implementation of the laelia.v1.IdentityProviderService
// service.
...
func NewIdentityProviderServiceHandler(svc IdentityProviderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/laelia.v1.IdentityProviderService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIdentityProviderServiceHandler) GetIdentityProvider(context.Context, *connect.Request[v1.GetIdentityProviderRequest]) (*connect.Response[v1.IdentityProvider], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.IdentityProviderService.GetIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) ListIdentityProviders(context.Context, *connect.Request[v1.ListIdentityProvidersRequest]) (*connect.Response[v1.ListIdentityProvidersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.IdentityProviderService.ListIdentityProviders is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) CreateIdentityProvider(context.Context, *connect.Request[v1.CreateIdentityProviderRequest]) (*connect.Response[v1.IdentityProvider], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.IdentityProviderService.CreateIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) UpdateIdentityProvider(context.Context, *connect.Request[v1.UpdateIdentityProviderRequest]) (*connect.Response[v1.IdentityProvider], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.IdentityProviderService.UpdateIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) DeleteIdentityProvider(context.Context, *connect.Request[v1.DeleteIdentityProviderRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.IdentityProviderService.DeleteIdentityProvider is not implemented"))
}
...
func (UnimplementedIdentityProviderServiceHandler) TestIdentityProvider(context.Context, *connect.Request[v1.TestIdentityProviderRequest]) (*connect.Response[v1.TestIdentityProviderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.IdentityProviderService.TestIdentityProvider is not implemented"))
}
