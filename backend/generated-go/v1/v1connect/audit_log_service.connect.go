...
const (
	...
	AuditLogServiceName = "laelia.v1.AuditLogService"
)
...
const (
	...
	// SearchAuditLogs RPC.
	AuditLogServiceSearchAuditLogsProcedure = "/laelia.v1.AuditLogService/SearchAuditLogs"
	// AuditLogServiceExportAuditLogsProcedure is the fully-qualified name of the AuditLogService's
	// ExportAuditLogs RPC.
	AuditLogServiceExportAuditLogsProcedure = "/laelia.v1.AuditLogService/ExportAuditLogs"
)

// AuditLogServiceClient is a client for the laelia.v1.AuditLogService service.
...
// NewAuditLogServiceClient constructs a client for the laelia.v1.AuditLogService service. By
...
// SearchAuditLogs calls laelia.v1.AuditLogService.SearchAuditLogs.
...
// ExportAuditLogs calls laelia.v1.AuditLogService.ExportAuditLogs.
...
// AuditLogServiceHandler is an implementation of the laelia.v1.AuditLogService service.
...
func NewAuditLogServiceHandler(svc AuditLogServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/laelia.v1.AuditLogService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditLogServiceHandler) SearchAuditLogs(context.Context, *connect.Request[v1.SearchAuditLogsRequest]) (*connect.Response[v1.SearchAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.AuditLogService.SearchAuditLogs is not implemented"))
}
...
func (UnimplementedAuditLogServiceHandler) ExportAuditLogs(context.Context, *connect.Request[v1.ExportAuditLogsRequest]) (*connect.Response[v1.ExportAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.AuditLogService.ExportAuditLogs is not implemented"))
}
