...
const (
	...
	RoleServiceName = "laelia.v1.RoleService"
)
...
const (
	...
	RoleServiceGetRoleProcedure = "/laelia.v1.RoleService/GetRole"
	// RoleServiceListRolesProcedure is the fully-qualified name of the RoleService's ListRoles RPC.
	RoleServiceListRolesProcedure = "/laelia.v1.RoleService/ListRoles"
	// RoleServiceCreateRoleProcedure is the fully-qualified name of the RoleService's CreateRole RPC.
	RoleServiceCreateRoleProcedure = "/laelia.v1.RoleService/CreateRole"
	// RoleServiceUpdateRoleProcedure is the fully-qualified name of the RoleService's UpdateRole RPC.
	RoleServiceUpdateRoleProcedure = "/laelia.v1.RoleService/UpdateRole"
	// RoleServiceDeleteRoleProcedure is the fully-qualified name of the RoleService's DeleteRole RPC.
	RoleServiceDeleteRoleProcedure = "/laelia.v1.RoleService/DeleteRole"
)

// RoleServiceClient is a client for the laelia.v1.RoleService service.
...
// NewRoleServiceClient constructs a client for the laelia.v1.RoleService service. By default, it
...
// GetRole calls laelia.v1.RoleService.GetRole.
...
// ListRoles calls laelia.v1.RoleService.ListRoles.
...
// CreateRole calls laelia.v1.RoleService.CreateRole.
...
// UpdateRole calls laelia.v1.RoleService.UpdateRole.
...
// DeleteRole calls laelia.v1.RoleService.DeleteRole.
...
// RoleServiceHandler is an implementation of the laelia.v1.RoleService service.
...
func NewRoleServiceHandler(svc RoleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/laelia.v1.RoleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRoleServiceHandler) GetRole(context.Context, *connect.Request[v1.GetRoleRequest]) (*connect.Response[v1.Role], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.RoleService.GetRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) ListRoles(context.Context, *connect.Request[v1.ListRolesRequest]) (*connect.Response[v1.ListRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.RoleService.ListRoles is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) CreateRole(context.Context, *connect.Request[v1.CreateRoleRequest]) (*connect.Response[v1.Role], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.RoleService.CreateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) UpdateRole(context.Context, *connect.Request[v1.UpdateRoleRequest]) (*connect.Response[v1.Role], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.RoleService.UpdateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) DeleteRole(context.Context, *connect.Request[v1.DeleteRoleRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("laelia.v1.RoleService.DeleteRole is not implemented"))
}
