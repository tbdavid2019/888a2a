...
type OAuth2IdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle        `protobuf:"varint,9,opt,name=auth_style,json=authStyle,proto3,enum=laelia.store.OAuth2AuthStyle" json:"auth_style,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type OIDCIdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle        `protobuf:"varint,6,opt,name=auth_style,json=authStyle,proto3,enum=laelia.store.OAuth2AuthStyle" json:"auth_style,omitempty"`
...
type LDAPIdentityProviderConfig struct {
	...
	SecurityProtocol LDAPIdentityProviderConfig_SecurityProtocol `protobuf:"varint,8,opt,name=security_protocol,json=securityProtocol,proto3,enum=laelia.store.LDAPIdentityProviderConfig_SecurityProtocol" json:"security_protocol,omitempty"`
...
const file_store_idp_proto_rawDesc = "" +
	"\n" +
	"\x0fstore/idp.proto\x12\flaelia.store\"\x8f\x02\n" +
	"\x16IdentityProviderConfig\x12Q\n" +
	"\roauth2_config\x18\x01 \x01(\v2*.laelia.store.OAuth2IdentityProviderConfigH\x00R\foauth2Config\x12K\n" +
	"\voidc_config\x18\x02 \x01(\v2(.laelia.store.OIDCIdentityProviderConfigH\x00R\n" +
	"oidcConfig\x12K\n" +
	"\vldap_config\x18\x03 \x01(\v2(.laelia.store.LDAPIdentityProviderConfigH\x00R\n" +
	"ldapConfigB\b\n" +
	"\x06config\"\xfb\x02\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x1a.laelia.store.FieldMappingR\ffieldMapping\x12&\n" +
	"\x0fskip_tls_verify\x18\b \x01(\bR\rskipTlsVerify\x12<\n" +
	"\n" +
	"auth_style\x18\t \x01(\x0e2\x1d.laelia.store.OAuth2AuthStyleR\tauthStyle\"\xb5\x02\n" +
	...
	"\rfield_mapping\x18\x04 \x01(\v2\x1a.laelia.store.FieldMappingR\ffieldMapping\x12&\n" +
	"\x0fskip_tls_verify\x18\x05 \x01(\bR\rskipTlsVerify\x12<\n" +
	"\n" +
	"auth_style\x18\x06 \x01(\x0e2\x1d.laelia.store.OAuth2AuthStyleR\tauthStyle\x12\x16\n" +
	"\x06scopes\x18\a \x03(\tR\x06scopes\"\xde\x03\n" +
	...
	"userFilter\x12f\n" +
	"\x11security_protocol\x18\b \x01(\x0e29.laelia.store.LDAPIdentityProviderConfig.SecurityProtocolR\x10securityProtocol\x12?\n" +
	"\rfield_mapping\x18\t \x01(\v2\x1a.laelia.store.FieldMappingR\ffieldMapping\"O\n" +
...
var file_store_idp_proto_goTypes = []any{
	(IdentityProviderType)(0),                        // 0: laelia.store.IdentityProviderType
	(OAuth2AuthStyle)(0),                             // 1: laelia.store.OAuth2AuthStyle
	(LDAPIdentityProviderConfig_SecurityProtocol)(0), // 2: laelia.store.LDAPIdentityProviderConfig.SecurityProtocol
	(*IdentityProviderConfig)(nil),                   // 3: laelia.store.IdentityProviderConfig
	(*OAuth2IdentityProviderConfig)(nil),             // 4: laelia.store.OAuth2IdentityProviderConfig
	(*OIDCIdentityProviderConfig)(nil),               // 5: laelia.store.OIDCIdentityProviderConfig
	(*LDAPIdentityProviderConfig)(nil),               // 6: laelia.store.LDAPIdentityProviderConfig
	(*FieldMapping)(nil),                             // 7: laelia.store.FieldMapping
	(*IdentityProviderUserInfo)(nil),                 // 8: laelia.store.IdentityProviderUserInfo
}
var file_store_idp_proto_depIdxs = []int32{
	4, // 0: laelia.store.IdentityProviderConfig.oauth2_config:type_name -> laelia.store.OAuth2IdentityProviderConfig
	5, // 1: laelia.store.IdentityProviderConfig.oidc_config:type_name -> laelia.store.OIDCIdentityProviderConfig
	6, // 2: laelia.store.IdentityProviderConfig.ldap_config:type_name -> laelia.store.LDAPIdentityProviderConfig
	7, // 3: laelia.store.OAuth2IdentityProviderConfig.field_mapping:type_name -> laelia.store.FieldMapping
	1, // 4: laelia.store.OAuth2IdentityProviderConfig.auth_style:type_name -> laelia.store.OAuth2AuthStyle
	7, // 5: laelia.store.OIDCIdentityProviderConfig.field_mapping:type_name -> laelia.store.FieldMapping
	1, // 6: laelia.store.OIDCIdentityProviderConfig.auth_style:type_name -> laelia.store.OAuth2AuthStyle
	2, // 7: laelia.store.LDAPIdentityProviderConfig.security_protocol:type_name -> laelia.store.LDAPIdentityProviderConfig.SecurityProtocol
	7, // 8: laelia.store.LDAPIdentityProviderConfig.field_mapping:type_name -> laelia.store.FieldMapping
