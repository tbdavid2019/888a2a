...
type GroupMember struct {
	...
	Role          GroupMember_Role `protobuf:"varint,2,opt,name=role,proto3,enum=laelia.store.GroupMember_Role" json:"role,omitempty"`
...
const file_store_group_proto_rawDesc = "" +
	"\n" +
	"\x11store/group.proto\x12\flaelia.store\"\x8e\x01\n" +
	"\vGroupMember\x12\x16\n" +
	"\x06member\x18\x01 \x01(\tR\x06member\x122\n" +
	"\x04role\x18\x02 \x01(\x0e2\x1e.laelia.store.GroupMember.RoleR\x04role\"3\n" +
	"\x04Role\x12\x14\n" +
...
var file_store_group_proto_goTypes = []any{
	(GroupMember_Role)(0), // 0: laelia.store.GroupMember.Role
	(*GroupMember)(nil),   // 1: laelia.store.GroupMember
	(*GroupPayload)(nil),  // 2: laelia.store.GroupPayload
}
var file_store_group_proto_depIdxs = []int32{
	0, // 0: laelia.store.GroupMember.role:type_name -> laelia.store.GroupMember.Role
	1, // 1: laelia.store.GroupPayload.members:type_name -> laelia.store.GroupMember
