...
func getConfigBytes(config *models.IdentityProviderConfig) ([]byte, error) {
...
func convertIdentityProviderType(identityProviderType string) models.IdentityProviderType {
	switch identityProviderType {
	case "OAUTH2":
		return models.IdentityProviderType_OAUTH2
	case "OIDC":
		return models.IdentityProviderType_OIDC
	case "LDAP":
		return models.IdentityProviderType_LDAP
	default:
		return models.IdentityProviderType_IDENTITY_PROVIDER_TYPE_UNSPECIFIED
	}
}

func convertIdentityProviderConfigString(identityProviderType models.IdentityProviderType, config string) *models.IdentityProviderConfig {
	identityProviderConfig := &models.IdentityProviderConfig{}
	switch identityProviderType {
	case models.IdentityProviderType_OAUTH2:
		var formattedConfig models.OAuth2IdentityProviderConfig
		if err := common.ProtojsonUnmarshaler.Unmarshal([]byte(config), &formattedConfig); err != nil {
			return nil
		}
		identityProviderConfig.Config = &models.IdentityProviderConfig_Oauth2Config{
			Oauth2Config: &formattedConfig,
		}
	case models.IdentityProviderType_OIDC:
		var formattedConfig models.OIDCIdentityProviderConfig
		if err := common.ProtojsonUnmarshaler.Unmarshal([]byte(config), &formattedConfig); err != nil {
			return nil
		}
		identityProviderConfig.Config = &models.IdentityProviderConfig_OidcConfig{
			OidcConfig: &formattedConfig,
		}
	case models.IdentityProviderType_LDAP:
		var formattedConfig models.LDAPIdentityProviderConfig
		if err := common.ProtojsonUnmarshaler.Unmarshal([]byte(config), &formattedConfig); err != nil {
			return nil
		}
		identityProviderConfig.Config = &models.IdentityProviderConfig_LdapConfig{
