...
- [ ] 5.3 Add provider compatibility documentation and real-runtime evidence templates; verify every claimed provider/version/platform result links to a reproducible gate.
